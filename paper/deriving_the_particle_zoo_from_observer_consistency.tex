...
a trial \(P\) feeds the source map \(P\mapsto M_U\mapsto\alpha_U\mapsto
...
checklist. The public fine-structure display row uses the OPH fixed-point equation with empirical
hadron-completed Thomson input, while the source-only audit row stays separate in the status table.
