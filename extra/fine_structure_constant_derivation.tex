...
\end{aligned}
\]
The displayed correction is calibration arithmetic. Its uncertainty is inherited from the measured fine-structure constant. The reported endpoint is
\[
